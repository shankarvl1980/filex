...
public class DeleteFileOtherActivityViewModel extends AndroidViewModel {
    ...
    //public List<FilePOJO> files_selected_for_delete;
    ...
    public synchronized void deleteFile(List<FilePOJO> msrc_file_list, FileObjectType mfileObjectType,Uri mtree_uri, String mtree_uri_path)
    {
