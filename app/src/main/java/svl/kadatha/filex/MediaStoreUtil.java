...
//import de.jeisfeld.augendiagnoselib.Application;
	...
	public final class MediaStoreUtil {
		 ...
		 */
		public static String getRealPathFromUri(@NonNull final Uri contentUri, Context context) {
			Cursor cursor = null;
			try {
		 ...
		 */
		public static Bitmap getThumbnailFromPath(final String path, final int maxSize,Context context) {
			ContentResolver resolver = context.getContentResolver();
		 ...
		 * @param path The path of the image
		 */
		public static void deleteThumbnail(final String path,Context context) {
			ContentResolver resolver = context.getContentResolver();
