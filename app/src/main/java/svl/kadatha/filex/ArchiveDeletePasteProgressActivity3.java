...
public class ArchiveDeletePasteProgressActivity3 extends BaseActivity
{
	...
	private ArchiveDeletePasteFileService3 archiveDeletePasteFileService;
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		serviceConnection=new ServiceConnection()
		{
			...
			{
				archiveDeletePasteFileService=((ArchiveDeletePasteFileService3.ArchiveDeletePasteBinder)binder).getService();
				archiveDeletePasteFileService.setServiceCompletionListener(new ArchiveDeletePasteFileService3.ServiceCompletionListener()
					{
	...
	protected void onNewIntent(Intent intent)
	{
		...
		if(action!=null && action.equals(ArchiveDeletePasteFileService3.REPLACE_ACTION))
		{
	...
	protected void onResume()
	{
		...
		Intent service_intent=new Intent(this,ArchiveDeletePasteFileService3.class);
