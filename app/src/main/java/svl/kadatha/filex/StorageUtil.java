...
public class StorageUtil {
    ...
    public static ArrayList<FilePOJO> getSdCardPaths(final Context context, final boolean includePrimaryExternalStorage) {
        ...
        STORAGE_DIR = new ArrayList<>(); //This is to ensure check on duplicate file paths
        {
            ...
            result.add(new FilePOJO(FileObjectType.ROOT_TYPE, "/", null, "/", true, 0L, null, 0L, null, R.drawable.folder_icon, null, Global.ENABLE_ALFA, View.INVISIBLE, View.INVISIBLE));
        }
    ...
    static FilePOJO MAKE_FilePOJO_ROOT(File f, boolean extract_icon) {
        ...
        int type = 0;
        return new FilePOJO(FileObjectType.ROOT_TYPE, name, null, path, isDirectory, dateLong, date, sizeLong, si, type, file_ext, alfa, play_overlay_visible, pdf_overlay_visible);
    }
}
