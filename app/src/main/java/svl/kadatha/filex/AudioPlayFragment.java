			...
			public void run()
			{
				...
				else
				{
					if(AudioPlayerActivity.AUDIO_FILE!=null)
					{
						...
						setTitleArt(AudioPlayerActivity.AUDIO_FILE.getTitle(),path, AudioPlayerActivity.getAlbumArt(context,path)); // dont try audio_player_service.current_audio, it may not have been instantiated.
