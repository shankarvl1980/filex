...
public class FileSelectorRecyclerViewLayout extends ViewGroup
{
    ...
    FileSelectorRecyclerViewLayout(Context context,boolean show_file_path,boolean grid_layout)
    {
        super(context);
    ...
    FileSelectorRecyclerViewLayout(Context context, AttributeSet attr, boolean show_file_path,boolean grid_layout)
    {
        super(context,attr);
        this.context=context;
        this.show_file_path=show_file_path;
    ...
    FileSelectorRecyclerViewLayout(Context context, AttributeSet attr, int defStyle, boolean show_file_path,boolean grid_layout)
    {
