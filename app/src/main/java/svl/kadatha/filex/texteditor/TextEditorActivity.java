...
import svl.kadatha.filex.ObservableScrollView;
...
public class TextEditorActivity extends BaseActivity implements TextEditorSettingsDialog.EOL_ChangeListener {
    ...
    private TextEditorSettingsDialog textEditorSettingsDialog;
    ...
    static Class getEmptyService() {
        ...
        if (TextSaveService1.SERVICE_COMPLETED) {
            emptyService = TextSaveService1.class;
        } else if (TextSaveService2.SERVICE_COMPLETED) {
            emptyService = TextSaveService2.class;
        }
        return emptyService;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewModel.isReadingFinished.observe(this, new Observer<AsyncTaskStatus>() {
            ...
            public void onChanged(AsyncTaskStatus asyncTaskStatus) {
                if (asyncTaskStatus == AsyncTaskStatus.STARTED) {
                    ...
                    file_text_container_edittext.setContent(viewModel.stringBuilder.toString(), viewModel.current_page, TextEditorViewModel.MAX_LINES_TO_DISPLAY);
        ...
        DeleteFileOtherActivityViewModel deleteFileOtherActivityViewModel = new ViewModelProvider(TextEditorActivity.this).get(DeleteFileOtherActivityViewModel.class);
    ...
    private void go_previous() {
        ...
        TextEditorViewModel.PagePointer prevPagePointer = viewModel.page_pointer_hashmap.get(previousPage);
    ...
    private void file_close_procedure() {
        ...
        } else if (!TextSaveService1.SERVICE_COMPLETED || !TextSaveService2.SERVICE_COMPLETED || !TextSaveService3.SERVICE_COMPLETED) {
            Global.print(context, getString(R.string.please_wait));
    ...
    private void start_file_save_service() {
        ...
        bundle.putString("temp_file_path", new File(getExternalCacheDir(), TextEditorViewModel.temp_content_file_name).getAbsolutePath());
    ...
    private class FileSaveServiceConnection implements ServiceConnection {
        Class service;
        TextSaveService1 textSaveService1;
        TextSaveService2 textSaveService2;
        ...
        public void onServiceConnected(ComponentName p1, IBinder binder) {
            switch (service.getName()) {
                case "svl.kadatha.filex.texteditor.TextSaveService1":
                    textSaveService1 = ((TextSaveService1.FileSaveServiceBinder) binder).getService();
                    if (textSaveService1 != null) {
                        textSaveService1.setFileSaveServiceCompletionListener(new TextSaveService1.FileSaveServiceCompletionListener() {
                            public void onServiceCompletion(TextSaveHelper.SaveResult saveResult) {
                    ...
                    break;
                case "svl.kadatha.filex.texteditor.TextSaveService2":
                    final TextSaveService2 textSaveService2 = ((TextSaveService2.FileSaveServiceBinder) binder).getService();
                    if (textSaveService2 != null) {
                        textSaveService2.setFileSaveServiceCompletionListener(new TextSaveService2.FileSaveServiceCompletionListener() {
                            public void onServiceCompletion(TextSaveHelper.SaveResult saveResult) {
                                if (saveResult.success) {
                                    viewModel.page_pointer_hashmap = saveResult.pagePointerHashmap;
                                    viewModel.current_page_end_point = viewModel.page_pointer_hashmap.get(viewModel.current_page).getEndPoint();
        ...
        public void onServiceDisconnected(ComponentName p1) {
            ...
            if (textSaveService1 != null) {
                textSaveService1.setFileSaveServiceCompletionListener(null);
            }
            if (textSaveService2 != null) {
                textSaveService2.setFileSaveServiceCompletionListener(null);
            }
        }
    }
}
