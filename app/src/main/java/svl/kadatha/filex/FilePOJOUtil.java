            ...
            if (fileObjectType == FileObjectType.ROOT_TYPE) {
                try {
                    if (RootUtils.canRunRootCommands()) {
                        String[] child_file_paths_array = RootUtils.listFilesInDirectory(fileclickselected);
                        if (child_file_paths_array != null) {
                            for (String child_file_path : child_file_paths_array) {
                                try {
                                    FilePOJO filePOJO = MakeFilePOJOUtil.MAKE_FilePOJO_ROOT(child_file_path, true, fileObjectType);
                                    if (!filePOJO.getName().startsWith(".")) {
                                        filePOJOS_filtered.add(filePOJO);
                                    ...
                                    Timber.w(itemEx, "ROOT item skipped: %s", child_file_path);
                                }
                            }
                        }
                    }
                } catch (Exception e) {
                    Timber.w(e, "ROOT_TYPE listing failed: %s", fileclickselected);
                }
                        ...
                        if (archive_view) {
                            for (Path path : directoryStream) {
                                try {
                                    ...
                                    Timber.w(itemEx, "FILE(ZIP) item skipped: %s", String.valueOf(path));
                                }
                            }
                        } else {
                            for (Path path : directoryStream) {
                                try {
                                    ...
                                    Timber.w(itemEx, "FILE item skipped: %s", String.valueOf(path));
                                }
                            }
                        }
                    } catch (IOException e) {
                        Timber.w(e, "FILE_TYPE listing failed: %s", fileclickselected);
                    }
                } else {
                    try {
                        if (archive_view) {
                        ...
                        Timber.w(e, "Legacy FILE_TYPE listing failed: %s", fileclickselected);
                    }
                }
                    ...
                    if (UsbFileRootSingleton.getInstance().isUsbFileRootSet()) {
                        try (ReadAccess access = UsbFileRootSingleton.getInstance().acquireUsbFileRootForRead()) {
                            ...
                            try {
                                ...
                                UsbFile[] file_array = (usbFile != null) ? usbFile.listFiles() : new UsbFile[0];
                                for (UsbFile f : file_array) {
                                    try {
                                        FilePOJO filePOJO = MakeFilePOJOUtil.MAKE_FilePOJO(f, true);
                                        // original logic: add all USB entries to filtered
                                        filePOJOS_filtered.add(filePOJO);
                                        filePOJOS.add(filePOJO);
                                    } catch (Exception itemEx) {
                                        Timber.w(itemEx, "USB item skipped: %s", f != null ? f.getName() : "null");
                                    }
                                }
                            } catch (IOException e) {
                                Timber.w(e, "USB_TYPE listFiles failed: %s", fileclickselected);
                            }
                        }
                    }
                } catch (Exception e) {
                    Timber.w(e, "USB_TYPE access failed: %s", fileclickselected);
                }
                ...
                try {
                    ...
                    for (FTPFile f : file_array) {
                        try {
                            ...
                            Timber.w(itemEx, "FTP item skipped");
                        }
                    }
                } catch (Exception e) {
                    Timber.w(e, "FTP_TYPE listing failed: %s", fileclickselected);
                } finally {
                    if (ftpClientRepository != null && ftpClient != null) {
                        ftpClientRepository.releaseFtpClient(ftpClient);
                    }
                ...
                try {
                    ...
                    for (ChannelSftp.LsEntry lsEntry : lsEntries) {
                        try {
                            ...
                            Timber.w(itemEx, "SFTP item skipped");
                        }
                    }
                } catch (Exception e) {
                    Timber.w(e, "SFTP_TYPE listing failed: %s", fileclickselected);
                } finally {
                    if (sftpChannelRepository != null && channelSftp != null) {
                        sftpChannelRepository.releaseChannel(channelSftp);
                    }
                ...
                try {
                    ...
                    for (DavResource resource : resources) {
                        try {
                            ...
                            Timber.w(itemEx, "WebDAV item skipped");
                        }
                    }
                } catch (IOException e) {
                    Timber.w(e, "WEBDAV_TYPE listing failed: %s", fileclickselected);
                }
                    ...
                    try (DiskShare share = (DiskShare) session.connectShare(shareName)) {
                        ...
                        for (FileIdBothDirectoryInformation info : fileList) {
                            ...
                            try {
                                ...
                                Timber.w(itemEx, "SMB item skipped: %s", name);
                            }
                        }
                    }
                } catch (Exception e) {
                    Timber.w(e, "SMB_TYPE listing failed: %s", fileclickselected);
                } finally {
                    if (smbClientRepository != null && session != null) {
                        smbClientRepository.releaseSession(session);
                    }
                ...
                try {
                    ...
                    for (GoogleDriveFileModel.GoogleDriveFileMetadata meta : driveFiles) {
                        try {
                            ...
                            Timber.w(itemEx, "GOOGLE_DRIVE item skipped");
                        }
                    }
                } catch (Exception e) {
                    Timber.w(e, "GOOGLE_DRIVE_TYPE listing failed: %s", fileclickselected);
                }
                ...
                try {
                    ...
                    for (Metadata meta : entries) {
                        try {
                            ...
                            Timber.w(itemEx, "DROPBOX item skipped");
                        }
                    }
                } catch (Exception e) {
                    Timber.w(e, "DROP_BOX_TYPE listing failed: %s", fileclickselected);
                }
                            ...
                            if (dirRes != null && dirRes._embedded != null && dirRes._embedded.items != null) {
                                for (MakeCloudFilePOJOUtil.YandexResource item : dirRes._embedded.items) {
                                    try {
                                        ...
                                        Timber.w(itemEx, "YANDEX item skipped");
                                    }
                                }
                            }
                        } else {
                            Timber.w("YANDEX_TYPE listing not successful: %s", fileclickselected);
                        }
                    }
                } catch (Exception e) {
                    Timber.w(e, "YANDEX_TYPE listing failed: %s", fileclickselected);
                }
            }

        } finally {
            RepositoryClass repositoryClass = RepositoryClass.getRepositoryClass();
            // store defensive copies so later mutations don’t alter the cache
            repositoryClass.hashmap_file_pojo.put(fileObjectType + fileclickselected, new ArrayList<>(filePOJOS));
            repositoryClass.hashmap_file_pojo_filtered.put(fileObjectType + fileclickselected, new ArrayList<>(filePOJOS_filtered));
        }
    }
